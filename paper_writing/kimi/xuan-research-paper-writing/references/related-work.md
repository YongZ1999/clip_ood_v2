...
Generate structured literature review based on user-provided core papers and candidate papers, making the novelty of your work easy to verify.

## Prerequisites

⚠️ **Important**: Before starting this section, candidate papers must have been summarized.

If candidate papers have not been summarized yet, please first call the `paper-summarizer` skill:
...
After generating draft, check the following:
...
- [ ] Technical distinction of your work is clearly stated
